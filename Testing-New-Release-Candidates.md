...
- Test that outgoing cookies are sent on Ad visits depending on the setting (the usual cookies when disabled, or none when enabled)  [Testcase](https://github.com/dhowe/AdNauseam/issues/920)
