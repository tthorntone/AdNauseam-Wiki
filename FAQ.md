...
AdNauseam's ad vault limits the number of displayed ads to 300 on the first load of the vault so that a user does not mistakenly load thousands of ads without realizing how long that may take. A user can, however, change the slider to as many ads as he/she wants to see on the page after the initial load.
