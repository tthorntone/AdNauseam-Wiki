...
AdNauseam is compatible with all Chromium-based based browsers (e.g. Opera, [Iron](https://www.srware.net/en/software_srware_iron_download.php), [Comodo Dragon](https://www.comodo.com/home/download/download.php?prod=browser), [Vivaldi](https://vivaldi.com/download/), etc), as well as Firefox and its derivatives (e.g., Firefox Mobile, Waterfox, etc). It requires workarounds on [Google Chrome](https://github.com/dhowe/AdNauseam/wiki/Install-AdNauseam-on-Chrome-Without-Google's-Permission) (and on a certain [ad-supported Firefox derivative](https://forum.palemoon.org/viewtopic.php?t=16504])), where it has been disallowed. If you are interested in working on a version for another browser (Safari, Edge, Brave, etc), please [contact the developers](mailto:adnauseam@rednoise.org) directly (do NOT create a github issue for such requests).
