...
The `beforescriptexecute` event is not specific to "Gecko-based extensions", it is part of the latest [W3C Working Draft](http://www.w3.org/TR/html5/scripting-1.html#scripting-1)...