µBlock can parse and enforce hosts file. For instance, µBlock supports out-of-the-box [Peter Lowe’s Ad server](http://pgl.yoyo.org/) list which contains over 2,400 ad servers.
