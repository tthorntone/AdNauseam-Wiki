...
Ok. I am willing to work to improve it though. But I do realize that regardless how I try to make it better, there will always be people ready to rate as low as possible. I mean 5 people disliked [this](https://www.youtube.com/watch?v=IIJzCeYsy2c), so an uninspiring computer tool which will be remembered by nobody in some near future has much more chance to be disliked.